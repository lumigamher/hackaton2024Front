...
function AssignedTask({taskName, deleteTask}) {
    return (
        <div className="flex justify-between px-5 py-3 items-center border-2 border-gray-200 rounded-2xl">
            ...
            <div className="flex justify-around gap-10">
                ...
                <i onClick={deleteTask} id={taskName} className='text-gray-400 hover:scale-125 cursor-pointer duration-300 bx bxs-trash-alt' ></i>
            </div>
        </div>
    )
}
